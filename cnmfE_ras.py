...
# %% First setup some parameters for motion correction
    f_dir = 'C:\\Users\\ys2605\\Desktop\\stuff\\data_others\\ras\\'
    f_name = 'Mov18_8bit';
    f_ext = 'tif'
...
# %% Parameters for source extraction and deconvolution (CNMF-E algorithm)
    ...
    gSiz = (17, 17)     # average diameter of a neuron, in general 2*gSig+1
    Ain = None          # possibility to seed with predetermined binary masks
    merge_thr = .7      # merging threshold, max correlation allowed
    rf = 512             # half-size of the patches in pixels. e.g., if rf=40, patches are 80x80
...
# %% MOVIES
    ...
    if display_images:
        ...
        cnm.estimates.play_movie(images, q_max=99.5, magnification=1,

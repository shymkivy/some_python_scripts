...
def main():
    ...
    #f_dir = 'E:\\data\\Auditory\\caiman_out\\movies\\'
    f_dir = 'C:\\Users\\rylab_dataPC\\Desktop\\Yuriy\\Victor_crap_data\\spine-calcium\\'
    ...
    #f_name = 'A1_freq_grating2_10_2_18_OA_cut';
    f_name = '23';
    #f_ext = 'hdf5'
    f_ext = 'tif'
    ...
    cnm.estimates.Cn = Cn
    cnm.save(os.path.splitext(fnames[0])[0]+'_ar'+str(p)+'_'+str(gSig[0])+'gsig_results.hdf5')
